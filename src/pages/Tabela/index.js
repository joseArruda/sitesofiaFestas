...
function Tabela () {
    ...
    <div className='corpo'>
        <div className='tabela-precos'  data-aos="flip-right" data-aos-duration="1500">
            <h1 className='pacote' data-aos="fade-up" data-aos-duration="1500"><img className='logo-infantil2' src={Logo1}/>Pacote Completo</h1>
    <div className='primeira-parte'>
        <div className="decoracao">
            <h2 className='estilo-subtitulo' data-aos="flip-right" data-aos-duration="1500">Decoração</h2>    
            <p>Mesa tema<br/>
            Painel de fundo<br/>
            Grama/ tapete<br/>
            Maquete<br/>
         ...
         <div className="buffet">
            <h2 data-aos="flip-right" data-aos-duration="1500" className='estilo-subtitulo'>Buffet</h2>
    ...
    <div className='segunda-parte'>
         <div className="bebidas">
            <h2 data-aos="flip-right" data-aos-duration="1500" className='estilo-subtitulo'>Bebidas</h2>
         ...
         <div className="equipe">
            <h2 data-aos="flip-right" data-aos-duration="1500" className='estilo-subtitulo'>Equipe</h2>
            <p>1 Decoradora<br/>
                1 Fritadeira<br/>
                1 Recepcionista<br/>
            ...
            <div className="descartavel">
                <h2 data-aos="flip-right" data-aos-duration="1500" className='estilo-subtitulo'>Todo material descartável incluso</h2>
                <p>Pratinhos<br/>
                    Colheres<br/>
                    Copos<br/>
                    Guardanapos
            ...
            <div data-aos="flip-right" data-aos-duration="1500" className="final">
            ...
            <div data-aos="flip-right" data-aos-duration="1500" className='valor'>
